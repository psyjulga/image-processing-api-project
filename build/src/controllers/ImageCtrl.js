...
var ImageCtrl = /** @class */ (function () {
    ...
    ImageCtrl.prototype.showImage = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var filename, width, height, imagePath, image;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        imagePath = path_1.default.resolve("images/thumb/".concat(filename, "-").concat(width, "-").concat(height, ".jpg"));
                        if (!(!filename || !width || !height)) return [3 /*break*/, 1];
                        res.status(400).send('query string missing - please use the following url format: /api/images?filename:YOURFILE&width:YOURWIDTH&height:YOURHEIGHT');
                        return [3 /*break*/, 4];
                    case 1:
